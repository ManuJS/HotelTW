 ...
 */
public class TelaBuscaHotel extends javax.swing.JPanel {
      ModeloDeBusca mdb = new ModeloDeBusca(); 
     ControleBuscaHotel c = new ControleBuscaHotel();
    /**
     * Creates new form TelaBuscaHotel2
     */
    public TelaBuscaHotel() {
        initComponents();
    }
...
public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaHotel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaBuscaHotel().setVisible(true);
            }
        });
    }
